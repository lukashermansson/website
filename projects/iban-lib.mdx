...
## Tech
I wrote the library in Rust, as I wanted to practice my Rust skills (I really enjoy writing Rust code) and also, thier ecosystem for dealing with libraries is amazing!

There is a bit of tests on the code, but it would be ideal to get a few more test cases with publicaly available bank account numvers, any tips on this would be greatly appreachiated
